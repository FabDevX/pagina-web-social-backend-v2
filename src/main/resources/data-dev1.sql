...
insert into users (id_user, uuid, name, last_name, email, phone, password, photo_cover_path, photo_profile_path)
    values(100, 'j5818068-9280-4055-987c-087f1b1f6635', 'Alicia', 'Mercado Sandoval', 'alicia.mercado@fcyt.umss.edu.bo', '79235628', '$2a$10$d2Re5HES0exoWQkbZ9IKSukZZI3kLokhOWJfRI1LZcuE/WN.zYV6e', null, 'https://devpws.cs.umss.edu.bo/api/v1/images/users/fc6cae6d-a3d4-48dd-8b3a-6572944dab5d' ),
       ...
       (110, 'a0818068-4880-4055-987c-087f1b1f6635', 'Sergio', 'Salazar Velasco', '202004185@est.umss.edu', '62954271', '$2a$10$APlIB7eBowR1Q00m.dEEZOKy3WzzWxtcpXogLThPH.MVAlx0mMwui', null, 'https://devpws.cs.umss.edu.bo/api/v1/images/users/13035150-f880-4475-808c-26086775ad47' ),
       (111, '9bae1fe0-2c56-4091-883d-15458e051500', 'Emely', 'Fernandez Soliz', '202004181@est.umss.edu', '69577142', '$2a$10$ElXlBz1WzNDhanqtCmszb.bub/iKGcNQgcbr31MQe9wjsiim7Q5zG', null, 'https://devpws.cs.umss.edu.bo/api/v1/images/users/733b01ba-198e-42db-b9ca-d7ace9a7abad'),
       (112, '844b324d-2f5e-41c9-b726-0149eeb01157', 'Javier', 'Lopez Canedo', '202394182@est.umss.edu', '71852821', '$2a$10$Gm0O/HK8qXeqa/XPvrm4/uAQj2.G3XdKOHg8XTxG4Gif1UYDPcbEa', null, 'https://devpws.cs.umss.edu.bo/api/v1/images/users/06b8fbe5-9d91-422b-bd20-6d89d23e5608'),
       (113, '2e121a51-24b5-4aad-92c2-150997ec4266', 'Leonardo', 'Beltran Ramirez', '202120735@est.umss.edu', '75891148', '$2a$10$vs8E1jwz6Z3BBitXHP.Y/uVQ0pNkqHhXf0oQCFH7Nf/rjccHL2lCO', null, 'https://devpws.cs.umss.edu.bo/api/v1/images/users/b5de2b13-4720-41e7-87d2-d31abd590fac'),
       (114, 'c332c4ff-49e8-4e0e-a7f4-d59907d8cda3', 'Valeria', 'Gonzales Vargas', 'svaleria.gonzales.vargas@gmail.com', '78823541', '$2a$10$tt2avNxEODCYrI9qHFqr5elrI5O87dVRNQZGUgAHVMUi8XtWnwXE.', null, 'https://devpws.cs.umss.edu.bo/api/v1/images/users/5e9f9c0d-4c31-4335-a11e-b9c7f6f8a2b1'),
       (115, '9f32985a-f108-4b19-9bda-cab7c501ae68', 'Jose', U&'Monta\00F1o Laura', '202001823@est.umss.edu', '72566218', '$2a$10$6HOIAlIZ2.KXIi8qL1AHxOIs3zHYydtV3QnZ.wJ9wrr18qhJEi576', null, 'https://devpws.cs.umss.edu.bo/api/v1/images/users/1bed8052-ba51-41c2-88b5-e39e78dbf420'),
       (116, 'ab6e1a7f-4494-4251-8177-dc5c4fe18740', 'Marcos', 'Illanes Martinez', '201800513@est.umss.edu', '74269527', '$2a$10$96.BNIsnUH7u.eVTeWi7Ju/exv59yfngw.TdVVOv5ladZ87KBZLaK', null, 'https://devpws.cs.umss.edu.bo/api/v1/images/users/28e3d103-76e8-4b0d-b04c-cf2e8821cf6e'),
       (117, 'f8d1c969-af76-4161-b0d7-9c2dfc47e75c', 'Adriana', 'Boza Ruiz', '201904940@est.umss.edu', '70551293', '$2a$10$LRWTNQMxRoDEGUKNeZe86OOg7.aqxc1TE/HhGUJ01zhPBB2E1O/A.', null, 'https://devpws.cs.umss.edu.bo/api/v1/images/users/f9c89556-cd27-481a-a8bd-59f4915f7dfa'),
       (118, 'd33ded75-c9f3-4fef-9762-0ba4a905efa8', 'Antonio', 'Monje Aranibar', '201604527@est.umss.edu', '62933721', '$2a$10$m8FJFWAPDKIAU8SykyKmme7FcaQqrkHtg0zczh3Gn0lSgVeTZNaAy', null, 'https://devpws.cs.umss.edu.bo/api/v1/images/users/b3a64fc9-3d28-4b92-b296-2324f9c4e061'),
       (119, 'e54bd4dc-d8f6-42e9-8e94-5d56bf42416f', 'Jeyson', 'Valdivia Bernal', 'jeyson.valdivia@gmail.com', '76834814', '$2a$10$anTAKIK4bm55/HYFWVoER.zu1eNL7Iwy0UCGi3THN.wDW77WaLCKa', null, 'https://devpws.cs.umss.edu.bo/api/v1/images/users/e326bdb8-6eee-4814-a877-9e063183f410'),
       (120, 'ae542968-1335-425e-a206-283c38a20190', 'Omar', 'Argenes Quispe', 'argenes77@gmail.com', '65692585', '$2a$10$bO6cOzFhvWjqRRwn7a1/xupq3LxGO/hG.7cLpS14JAbksNjBGJCjW', null, 'https://devpws.cs.umss.edu.bo/api/v1/images/users/004fca51-d313-41c4-94ff-5908ddb58dc2'),
       (121, '7f9264d7-ca8d-41ca-be1f-d24c9dd244a2', 'Bianca', 'Antelo Dominguez', 'bianca.dominguez@gmail.com', '73597236', '$2a$10$QUoVqY/j3bdW5rOMO8aTY.Eaq2Ifju9a8Hm2ht7qex2ALF0tWVc1q', null, 'https://devpws.cs.umss.edu.bo/api/v1/images/users/2148f392-4f16-40b6-88e7-bd0ca32bd84a'),
       (122, '7f9264d7-ca8d-41ca-be1f-d24c9dd12345', 'Zoe', 'Quispe Dominguez', 'zoedominguez@gmail.com', '73597236', '$2a$10$QUoVqY/j3bdW5rOMO8aTY.Eaq2Ifju9a8Hm2ht7qex2ALF0tWVc1q', null, 'https://devpws.cs.umss.edu.bo/api/v1/images/users/2148f392-4f16-40b6-88e7-bd0ca32bd84a');
...
values(100, '17ucf8a1-09e0-4435-a850-0613d778897b', '1e5294f8-9a6c-4d9e-aea7-da7e80bd5c6f', 1, 'img01', 'image', 'https://devpws.cs.umss.edu.bo/api/v1/images/posts/3fddcbec-4bbe-411d-949a-4e4ab9fa986a'),
    (101, '81k7f8a1-09e0-4435-a850-0613d778897b', '6i2494f8-9a6c-4d9e-aea7-da7e80bd5c6f', 1, 'img02', 'image', 'https://devpws.cs.umss.edu.bo/api/v1/images/posts/6e8fb6b1-fa25-43c8-a4f7-97c5fe8d8286'),
    (102, '24l5f8a1-09e0-4435-a850-0613d778897b', '8f3194f8-9a6c-4d9e-aea7-da7e80bd5c6f', 1, 'img03', 'image', 'https://devpws.cs.umss.edu.bo/api/v1/images/posts/e970d0cc-a76f-4884-9d05-574316eb7f94'),
    (103, '79a3f8a1-09e0-4435-a850-0613d778897b', '5l6n94f8-9a6c-4d9e-aea7-da7e80bd5c6f', 1, 'img04', 'image', 'https://devpws.cs.umss.edu.bo/api/v1/images/posts/eec636b7-f44b-4bac-b471-aacda7566a01'),
    (104, '38j1f8a1-09e0-4435-a850-0613d778897b', '2v4z94f8-9a6c-4d9e-aea7-da7e80bd5c6f', 1, 'img05', 'image', 'https://devpws.cs.umss.edu.bo/api/v1/images/posts/8dce74bc-bf71-4d65-8c0d-f447dfa0ad21'),
    (105, '2k9zf8a1-09e0-4435-a850-0613d778897b', '7o1b94f8-9a6c-4d9e-aea7-da7e80bd5c6f', 1, 'img06', 'image', 'https://devpws.cs.umss.edu.bo/api/v1/images/posts/d07799d0-e0ac-4da2-b1fe-c36387f3e0b8'),
    (106, '6m1vf8a1-09e0-4435-a850-0613d778897b', '7o1b94f8-9a6c-4d9e-aea7-da7e80bd5c6f', 2, 'img07', 'image', 'https://devpws.cs.umss.edu.bo/api/v1/images/posts/44251647-1ea0-4e8a-bbbf-fba398448519'),
    (107, '17b9m4z3-09e0-4435-a850-0613d778897b', '3m8c52v4-9a6c-4d9e-aea7-da7e80bd5c6f', 1, 'img08', 'image', 'https://devpws.cs.umss.edu.bo/api/v1/images/posts/8c017615-a405-4b01-a9bd-7796710552ba'),
    (108, '5jc8x7v4-09e0-4435-a850-0613d778897b', '1om5x7n2-9a6c-4d9e-aea7-da7e80bd5c6f', 1, 'img09', 'image', 'https://devpws.cs.umss.edu.bo/api/v1/images/posts/703a9df8-fb13-4e02-acf0-12726d175380'),
    (109, '8xm4v1n3-09e0-4435-a850-0613d778897b', '4g9dn2m6-9a6c-4d9e-aea7-da7e80bd5c6f', 1, 'img10', 'image', 'https://devpws.cs.umss.edu.bo/api/v1/images/posts/e30629ef-d0e2-47f2-8fbb-cb3344e4f319'),
    (110, '3v7c2gs8-09e0-4435-a850-0613d778897b', '9vm3n7a3-9a6c-4d9e-aea7-da7e80bd5c6f', 1, 'img11', 'image', 'https://devpws.cs.umss.edu.bo/api/v1/images/posts/b96f6ec8-655f-45de-943b-107300a8e25a'),
    (111, 'l2n5c0f7-09e0-4435-a850-0613d778897b', 'n5x8f0j2-9a6c-4d9e-aea7-da7e80bd5c6f', 1, 'img12', 'image', 'https://devpws.cs.umss.edu.bo/api/v1/images/posts/3bcb7ab3-af96-4342-b342-0e7b841d76a5'),
    (112, 'j4v9e6l1-09e0-4435-a850-0613d778897b', 'g7k3v8d5-9a6c-4d9e-aea7-da7e80bd5c6f', 1, 'img13', 'image', 'https://devpws.cs.umss.edu.bo/api/v1/images/posts/b65f8646-ebf4-4bec-9403-df64908ac870'),
    (113, 'h6m2s9c7-09e0-4435-a850-0613d778897b', 'k3n6m1a9-9a6c-4d9e-aea7-da7e80bd5c6f', 1, 'img14', 'image', 'https://devpws.cs.umss.edu.bo/api/v1/images/posts/18e154d3-c772-4dd0-ac24-847cefc0679a');
...
insert into image_file (id, uuid, name, url_resource, status, type)
    values (100, '3fddcbec-4bbe-411d-949a-4e4ab9fa986a', 'img01', 'https://devpws.cs.umss.edu.bo/api/v1/images/posts/3fddcbec-4bbe-411d-949a-4e4ab9fa986a', 'SAVED_SUCCESSFULLY','image/jpeg'),
     (101, '6e8fb6b1-fa25-43c8-a4f7-97c5fe8d8286', 'img02', 'https://devpws.cs.umss.edu.bo/api/v1/images/posts/6e8fb6b1-fa25-43c8-a4f7-97c5fe8d8286', 'SAVED_SUCCESSFULLY','image/jpeg'),
     (102, 'e970d0cc-a76f-4884-9d05-574316eb7f94', 'img03', 'https://devpws.cs.umss.edu.bo/api/v1/images/posts/e970d0cc-a76f-4884-9d05-574316eb7f94', 'SAVED_SUCCESSFULLY','image/jpeg'),
     (103, 'eec636b7-f44b-4bac-b471-aacda7566a01', 'img04', 'https://devpws.cs.umss.edu.bo/api/v1/images/posts/eec636b7-f44b-4bac-b471-aacda7566a01', 'SAVED_SUCCESSFULLY','image/jpeg'),
     (104, '8dce74bc-bf71-4d65-8c0d-f447dfa0ad21', 'img05', 'https://devpws.cs.umss.edu.bo/api/v1/images/posts/8dce74bc-bf71-4d65-8c0d-f447dfa0ad21', 'SAVED_SUCCESSFULLY','image/jpeg'),
     (105, 'd07799d0-e0ac-4da2-b1fe-c36387f3e0b8', 'img06', 'https://devpws.cs.umss.edu.bo/api/v1/images/posts/d07799d0-e0ac-4da2-b1fe-c36387f3e0b8', 'SAVED_SUCCESSFULLY','image/jpeg'),
     (106, '44251647-1ea0-4e8a-bbbf-fba398448519', 'img07', 'https://devpws.cs.umss.edu.bo/api/v1/images/posts/44251647-1ea0-4e8a-bbbf-fba398448519', 'SAVED_SUCCESSFULLY','image/jpeg'),
     (107, '8c017615-a405-4b01-a9bd-7796710552ba', 'img08', 'https://devpws.cs.umss.edu.bo/api/v1/images/posts/8c017615-a405-4b01-a9bd-7796710552ba', 'SAVED_SUCCESSFULLY','image/jpeg'),
     (108, '703a9df8-fb13-4e02-acf0-12726d175380', 'img09', 'https://devpws.cs.umss.edu.bo/api/v1/images/posts/703a9df8-fb13-4e02-acf0-12726d175380', 'SAVED_SUCCESSFULLY','image/jpeg'),
     (109, 'e30629ef-d0e2-47f2-8fbb-cb3344e4f319', 'img10', 'https://devpws.cs.umss.edu.bo/api/v1/images/posts/e30629ef-d0e2-47f2-8fbb-cb3344e4f319', 'SAVED_SUCCESSFULLY','image/jpeg'),
     (110, 'b96f6ec8-655f-45de-943b-107300a8e25a', 'img11', 'https://devpws.cs.umss.edu.bo/api/v1/images/posts/b96f6ec8-655f-45de-943b-107300a8e25a', 'SAVED_SUCCESSFULLY','image/jpeg'),
     (111, '012aa435-6925-4ba8-ba90-af529c8344ef', 'img12', 'https://devpws.cs.umss.edu.bo/api/v1/images/inst-profile/012aa435-6925-4ba8-ba90-af529c8344ef', 'SAVED_SUCCESSFULLY','image/png'),
     (112, '1cf06b76-d37a-47a1-8c73-6c9e4df0e8fe', 'img13', 'https://devpws.cs.umss.edu.bo/api/v1/images/inst-cover/1cf06b76-d37a-47a1-8c73-6c9e4df0e8fe', 'SAVED_SUCCESSFULLY','image/jpg'),
     (113, '3bcb7ab3-af96-4342-b342-0e7b841d76a5', 'img14', 'https://devpws.cs.umss.edu.bo/api/v1/images/posts/3bcb7ab3-af96-4342-b342-0e7b841d76a5', 'SAVED_SUCCESSFULLY','image/jpeg'),
     (114, 'fc6cae6d-a3d4-48dd-8b3a-6572944dab5d', 'img15', 'https://devpws.cs.umss.edu.bo/api/v1/images/users/fc6cae6d-a3d4-48dd-8b3a-6572944dab5d', 'SAVED_SUCCESSFULLY','image/png'),
     (115, '13035150-f880-4475-808c-26086775ad47', 'img16', 'https://devpws.cs.umss.edu.bo/api/v1/images/users/13035150-f880-4475-808c-26086775ad47', 'SAVED_SUCCESSFULLY','image/png'),
     (116, 'b65f8646-ebf4-4bec-9403-df64908ac870', 'img17', 'https://devpws.cs.umss.edu.bo/api/v1/images/posts/b65f8646-ebf4-4bec-9403-df64908ac870', 'SAVED_SUCCESSFULLY','image/jpeg'),
     (117, 'e867fa32-75b7-4c3c-8943-4a2808c10ac0', 'img18', 'https://devpws.cs.umss.edu.bo/api/v1/images/users/e867fa32-75b7-4c3c-8943-4a2808c10ac0', 'SAVED_SUCCESSFULLY','image/png'),
     (118, '733b01ba-198e-42db-b9ca-d7ace9a7abad', 'img19', 'https://devpws.cs.umss.edu.bo/api/v1/images/users/733b01ba-198e-42db-b9ca-d7ace9a7abad', 'SAVED_SUCCESSFULLY','image/png'),
     (119, '06b8fbe5-9d91-422b-bd20-6d89d23e5608', 'img20', 'https://devpws.cs.umss.edu.bo/api/v1/images/users/06b8fbe5-9d91-422b-bd20-6d89d23e5608', 'SAVED_SUCCESSFULLY','image/png'),
     (120, 'b5de2b13-4720-41e7-87d2-d31abd590fac', 'img21', 'https://devpws.cs.umss.edu.bo/api/v1/images/users/b5de2b13-4720-41e7-87d2-d31abd590fac', 'SAVED_SUCCESSFULLY','image/png'),
     (121, '5e9f9c0d-4c31-4335-a11e-b9c7f6f8a2b1', 'img22', 'https://devpws.cs.umss.edu.bo/api/v1/images/users/5e9f9c0d-4c31-4335-a11e-b9c7f6f8a2b1', 'SAVED_SUCCESSFULLY','image/png'),
     (122, '1bed8052-ba51-41c2-88b5-e39e78dbf420', 'img23', 'https://devpws.cs.umss.edu.bo/api/v1/images/users/1bed8052-ba51-41c2-88b5-e39e78dbf420', 'SAVED_SUCCESSFULLY','image/png'),
     (123, '28e3d103-76e8-4b0d-b04c-cf2e8821cf6e', 'img24', 'https://devpws.cs.umss.edu.bo/api/v1/images/users/28e3d103-76e8-4b0d-b04c-cf2e8821cf6e', 'SAVED_SUCCESSFULLY','image/png'),
     (124, 'f9c89556-cd27-481a-a8bd-59f4915f7dfa', 'img25', 'https://devpws.cs.umss.edu.bo/api/v1/images/users/f9c89556-cd27-481a-a8bd-59f4915f7dfa', 'SAVED_SUCCESSFULLY','image/png'),
     (125, 'b3a64fc9-3d28-4b92-b296-2324f9c4e061', 'img26', 'https://devpws.cs.umss.edu.bo/api/v1/images/users/b3a64fc9-3d28-4b92-b296-2324f9c4e061', 'SAVED_SUCCESSFULLY','image/png'),
     (126, 'e326bdb8-6eee-4814-a877-9e063183f410', 'img27', 'https://devpws.cs.umss.edu.bo/api/v1/images/users/e326bdb8-6eee-4814-a877-9e063183f410', 'SAVED_SUCCESSFULLY','image/png'),
     (127, '004fca51-d313-41c4-94ff-5908ddb58dc2', 'img28', 'https://devpws.cs.umss.edu.bo/api/v1/images/users/004fca51-d313-41c4-94ff-5908ddb58dc2', 'SAVED_SUCCESSFULLY','image/png'),
     (128, '2148f392-4f16-40b6-88e7-bd0ca32bd84a', 'img29', 'https://devpws.cs.umss.edu.bo/api/v1/images/users/2148f392-4f16-40b6-88e7-bd0ca32bd84a', 'SAVED_SUCCESSFULLY','image/png'),
     (129, '18e154d3-c772-4dd0-ac24-847cefc0679a', 'img30', 'https://devpws.cs.umss.edu.bo/api/v1/images/posts/18e154d3-c772-4dd0-ac24-847cefc0679a', 'SAVED_SUCCESSFULLY', 'image/jpeg');
